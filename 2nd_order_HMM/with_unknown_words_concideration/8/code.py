...
str_pythontex=[float("{0:.2f}".format(list(table_8.loc["A"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["A"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["A"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["A"])[4]*100)),
round(list(table_8.loc["A"])[3]),round(list(table_8.loc["A"])[5]),
float("{0:.2f}".format(list(table_8.loc["B"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["B"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["B"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["B"])[4]*100)),
round(list(table_8.loc["B"])[3]),round(list(table_8.loc["B"])[5]),
float("{0:.2f}".format(list(table_8.loc["C"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["C"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["C"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["C"])[4]*100)),
round(list(table_8.loc["C"])[3]),round(list(table_8.loc["C"])[5]),
float("{0:.2f}".format(list(table_8.loc["D"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["D"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["D"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["D"])[4]*100)),
round(list(table_8.loc["D"])[3]),round(list(table_8.loc["D"])[5]),
float("{0:.2f}".format(list(table_8.loc["E"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["E"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["E"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["E"])[4]*100)),
round(list(table_8.loc["E"])[3]),round(list(table_8.loc["E"])[5]),
float("{0:.2f}".format(list(table_8.loc["F"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["F"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["F"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["F"])[4]*100)),
round(list(table_8.loc["F"])[3]),round(list(table_8.loc["F"])[5]),
float("{0:.2f}".format(list(table_8.loc["G"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["G"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["G"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["G"])[4]*100)),
round(list(table_8.loc["G"])[3]),round(list(table_8.loc["G"])[5]),
float("{0:.2f}".format(list(table_8.loc["H"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["H"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["H"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["H"])[4]*100)),
round(list(table_8.loc["H"])[3]),round(list(table_8.loc["H"])[5]),
float("{0:.2f}".format(list(table_8.loc["I"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["I"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["I"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["I"])[4]*100)),
round(list(table_8.loc["I"])[3]),round(list(table_8.loc["I"])[5]),
float("{0:.2f}".format(list(table_8.loc["J"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["J"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["J"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["J"])[4]*100)),
round(list(table_8.loc["J"])[3]),round(list(table_8.loc["J"])[5]),
float("{0:.2f}".format(list(table_8.loc["K"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["K"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["K"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["K"])[4]*100)),
round(list(table_8.loc["K"])[3]),round(list(table_8.loc["K"])[5]),
float("{0:.2f}".format(list(table_8.loc["L"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["L"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["L"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["L"])[4]*100)),
round(list(table_8.loc["L"])[3]),round(list(table_8.loc["L"])[5]),
float("{0:.2f}".format(list(table_8.loc["M"])[0]*100)),float("{0:.2f}".format(list(table_8.loc["M"])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["M"])[2]*100)),float("{0:.2f}".format(list(table_8.loc["M"])[4]*100)),
round(list(table_8.loc["M"])[3]),round(list(table_8.loc["M"])[5]),
float("{0:.2f}".format(list(table_8.loc["."])[0]*100)),float("{0:.2f}".format(list(table_8.loc["."])[1]*100)),
float("{0:.2f}".format(list(table_8.loc["."])[2]*100)),float("{0:.2f}".format(list(table_8.loc["."])[4]*100)),
round(list(table_8.loc["."])[3]),round(list(table_8.loc["."])[5]),
...
v8=[float("{0:.2f}".format(float(accuracy)*100)),float("{0:.2f}".format(float(f1)*100)),
float("{0:.2f}".format(float(unknown_ac)*100)),float("{0:.2f}".format(float(known_ac)*100)),
len(word2idx)-w_known,float("{0:.2f}".format(float((len(word2idx)-w_known)/len(word2idx))*100))]
