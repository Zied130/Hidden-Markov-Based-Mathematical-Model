...
a1=np.mean([table_1.loc['A'].accuracy,table_2.loc['A'].accuracy,table_3.loc['A'].accuracy,table_4.loc['A'].accuracy,
...
a2=np.mean([table_1.loc['A'].f1_score,table_2.loc['A'].f1_score,table_3.loc['A'].f1_score,table_4.loc['A'].f1_score,
...
a3=np.mean([table_1.loc['A'][2],table_2.loc['A'][2],table_3.loc['A'][2],table_4.loc['A'][2],
           table_5.loc['A'][2],table_6.loc['A'][2],table_7.loc['A'][2],table_8.loc['A'][2],
           table_9.loc['A'][2],table_10.loc['A'][2]])


a4=np.mean([table_1.loc['A'][3],table_2.loc['A'][3],table_3.loc['A'][3],table_4.loc['A'][3],
           table_5.loc['A'][3],table_6.loc['A'][3],table_7.loc['A'][3],table_8.loc['A'][3],
           table_9.loc['A'][3],table_10.loc['A'][3]])

a5=np.mean([table_1.loc['A'][4],table_2.loc['A'][4],table_3.loc['A'][4],table_4.loc['A'][4],
           table_5.loc['A'][4],table_6.loc['A'][4],table_7.loc['A'][4],table_8.loc['A'][4],
           table_9.loc['A'][4],table_10.loc['A'][4]])

a6=np.mean([table_1.loc['A'][5],table_2.loc['A'][5],table_3.loc['A'][5],table_4.loc['A'][5],
           table_5.loc['A'][5],table_6.loc['A'][5],table_7.loc['A'][5],table_8.loc['A'][5],
           table_9.loc['A'][5],table_10.loc['A'][5]])

a7=np.mean([table_1.loc['B'].accuracy,table_2.loc['B'].accuracy,table_3.loc['B'].accuracy,table_4.loc['B'].accuracy,
...
a8=np.mean([table_1.loc['B'].f1_score,table_2.loc['B'].f1_score,table_3.loc['B'].f1_score,table_4.loc['B'].f1_score,
...
a9=np.mean([table_1.loc['B'][2],table_2.loc['B'][2],table_3.loc['B'][2],table_4.loc['B'][2],
           table_5.loc['B'][2],table_6.loc['B'][2],table_7.loc['B'][2],table_8.loc['B'][2],
           table_9.loc['B'][2],table_10.loc['B'][2]])


a10=np.mean([table_1.loc['B'][3],table_2.loc['B'][3],table_3.loc['B'][3],table_4.loc['B'][3],
           table_5.loc['B'][3],table_6.loc['B'][3],table_7.loc['B'][3],table_8.loc['B'][3],
           table_9.loc['B'][3],table_10.loc['B'][3]])

a11=np.mean([table_1.loc['B'][4],table_2.loc['B'][4],table_3.loc['B'][4],table_4.loc['B'][4],
           table_5.loc['B'][4],table_6.loc['B'][4],table_7.loc['B'][4],table_8.loc['B'][4],
           table_9.loc['B'][4],table_10.loc['B'][4]])

a12=np.mean([table_1.loc['B'][5],table_2.loc['B'][5],table_3.loc['B'][5],table_4.loc['B'][5],
           table_5.loc['B'][5],table_6.loc['B'][5],table_7.loc['B'][5],table_8.loc['B'][5],
           table_9.loc['B'][5],table_10.loc['B'][5]])


a13=np.mean([table_1.loc['C'].accuracy,table_2.loc['C'].accuracy,table_3.loc['C'].accuracy,table_4.loc['C'].accuracy,
...
a14=np.mean([table_1.loc['C'].f1_score,table_2.loc['C'].f1_score,table_3.loc['C'].f1_score,table_4.loc['C'].f1_score,
...
a15=np.mean([table_1.loc['C'][2],table_2.loc['C'][2],table_3.loc['C'][2],table_4.loc['C'][2],
           table_5.loc['C'][2],table_6.loc['C'][2],table_7.loc['C'][2],table_8.loc['C'][2],
           table_9.loc['C'][2],table_10.loc['C'][2]])


a16=np.mean([table_1.loc['C'][3],table_2.loc['C'][3],table_3.loc['C'][3],table_4.loc['C'][3],
           table_5.loc['C'][3],table_6.loc['C'][3],table_7.loc['C'][3],table_8.loc['C'][3],
           table_9.loc['C'][3],table_10.loc['C'][3]])

a17=np.mean([table_1.loc['C'][4],table_2.loc['C'][4],table_3.loc['C'][4],table_4.loc['C'][4],
           table_5.loc['C'][4],table_6.loc['C'][4],table_7.loc['C'][4],table_8.loc['C'][4],
           table_9.loc['C'][4],table_10.loc['C'][4]])

a18=np.mean([table_1.loc['C'][5],table_2.loc['C'][5],table_3.loc['C'][5],table_4.loc['C'][5],
           table_5.loc['C'][5],table_6.loc['C'][5],table_7.loc['C'][5],table_8.loc['C'][5],
           table_9.loc['C'][5],table_10.loc['C'][5]])

a19=np.mean([table_1.loc['D'].accuracy,table_2.loc['D'].accuracy,table_3.loc['D'].accuracy,table_4.loc['D'].accuracy,
...
a20=np.mean([table_1.loc['D'].f1_score,table_2.loc['D'].f1_score,table_3.loc['D'].f1_score,table_4.loc['D'].f1_score,
...
a21=np.mean([table_1.loc['D'][2],table_2.loc['D'][2],table_3.loc['D'][2],table_4.loc['D'][2],
           table_5.loc['D'][2],table_6.loc['D'][2],table_7.loc['D'][2],table_8.loc['D'][2],
           table_9.loc['D'][2],table_10.loc['D'][2]])


a22=np.mean([table_1.loc['D'][3],table_2.loc['D'][3],table_3.loc['D'][3],table_4.loc['D'][3],
           table_5.loc['D'][3],table_6.loc['D'][3],table_7.loc['D'][3],table_8.loc['D'][3],
           table_9.loc['D'][3],table_10.loc['D'][3]])

a23=np.mean([table_1.loc['D'][4],table_2.loc['D'][4],table_3.loc['D'][4],table_4.loc['D'][4],
           table_5.loc['D'][4],table_6.loc['D'][4],table_7.loc['D'][4],table_8.loc['D'][4],
           table_9.loc['D'][4],table_10.loc['D'][4]])

a24=np.mean([table_1.loc['D'][5],table_2.loc['D'][5],table_3.loc['D'][5],table_4.loc['D'][5],
           table_5.loc['D'][5],table_6.loc['D'][5],table_7.loc['D'][5],table_8.loc['D'][5],
           table_9.loc['D'][5],table_10.loc['D'][5]])


a25=np.mean([table_1.loc['E'].accuracy,table_2.loc['E'].accuracy,table_3.loc['E'].accuracy,table_4.loc['E'].accuracy,
...
a26=np.mean([table_1.loc['E'].f1_score,table_2.loc['E'].f1_score,table_3.loc['E'].f1_score,table_4.loc['E'].f1_score,
...
a27=np.mean([table_1.loc['E'][2],table_2.loc['E'][2],table_3.loc['E'][2],table_4.loc['E'][2],
           table_5.loc['E'][2],table_6.loc['E'][2],table_7.loc['E'][2],table_8.loc['E'][2],
           table_9.loc['E'][2],table_10.loc['E'][2]])


a28=np.mean([table_1.loc['E'][3],table_2.loc['E'][3],table_3.loc['E'][3],table_4.loc['E'][3],
           table_5.loc['E'][3],table_6.loc['E'][3],table_7.loc['E'][3],table_8.loc['E'][3],
           table_9.loc['E'][3],table_10.loc['E'][3]])

a29=np.mean([table_1.loc['E'][4],table_2.loc['E'][4],table_3.loc['E'][4],table_4.loc['E'][4],
           table_5.loc['E'][4],table_6.loc['E'][4],table_7.loc['E'][4],table_8.loc['E'][4],
           table_9.loc['E'][4],table_10.loc['E'][4]])

a30=np.mean([table_1.loc['E'][5],table_2.loc['E'][5],table_3.loc['E'][5],table_4.loc['E'][5],
           table_5.loc['E'][5],table_6.loc['E'][5],table_7.loc['E'][5],table_8.loc['E'][5],
           table_9.loc['E'][5],table_10.loc['E'][5]])


a31=np.mean([table_1.loc['F'].accuracy,table_2.loc['F'].accuracy,table_3.loc['F'].accuracy,table_4.loc['F'].accuracy,
...
a32=np.mean([table_1.loc['F'].f1_score,table_2.loc['F'].f1_score,table_3.loc['F'].f1_score,table_4.loc['F'].f1_score,
...
a33=np.mean([table_1.loc['F'][2],table_2.loc['F'][2],table_3.loc['F'][2],table_4.loc['F'][2],
           table_5.loc['F'][2],table_6.loc['F'][2],table_7.loc['F'][2],table_8.loc['F'][2],
           table_9.loc['F'][2],table_10.loc['F'][2]])


a34=np.mean([table_1.loc['F'][3],table_2.loc['F'][3],table_3.loc['F'][3],table_4.loc['F'][3],
           table_5.loc['F'][3],table_6.loc['F'][3],table_7.loc['F'][3],table_8.loc['F'][3],
           table_9.loc['F'][3],table_10.loc['F'][3]])

a35=np.mean([table_1.loc['F'][4],table_2.loc['F'][4],table_3.loc['F'][4],table_4.loc['F'][4],
           table_5.loc['F'][4],table_6.loc['F'][4],table_7.loc['F'][4],table_8.loc['F'][4],
           table_9.loc['F'][4],table_10.loc['F'][4]])

a36=np.mean([table_1.loc['F'][5],table_2.loc['F'][5],table_3.loc['F'][5],table_4.loc['F'][5],
           table_5.loc['F'][5],table_6.loc['F'][5],table_7.loc['F'][5],table_8.loc['F'][5],
           table_9.loc['F'][5],table_10.loc['F'][5]])

a37=np.mean([table_1.loc['G'].accuracy,table_2.loc['G'].accuracy,table_3.loc['G'].accuracy,table_4.loc['G'].accuracy,
...
a38=np.mean([table_1.loc['G'].f1_score,table_2.loc['G'].f1_score,table_3.loc['G'].f1_score,table_4.loc['G'].f1_score,
...
a39=np.mean([table_1.loc['G'][2],table_2.loc['G'][2],table_3.loc['G'][2],table_4.loc['G'][2],
           table_5.loc['G'][2],table_6.loc['G'][2],table_7.loc['G'][2],table_8.loc['G'][2],
           table_9.loc['G'][2],table_10.loc['G'][2]])


a40=np.mean([table_1.loc['G'][3],table_2.loc['G'][3],table_3.loc['G'][3],table_4.loc['G'][3],
           table_5.loc['G'][3],table_6.loc['G'][3],table_7.loc['G'][3],table_8.loc['G'][3],
           table_9.loc['G'][3],table_10.loc['G'][3]])

a41=np.mean([table_1.loc['G'][4],table_2.loc['G'][4],table_3.loc['G'][4],table_4.loc['G'][4],
           table_5.loc['G'][4],table_6.loc['G'][4],table_7.loc['G'][4],table_8.loc['G'][4],
           table_9.loc['G'][4],table_10.loc['G'][4]])

a42=np.mean([table_1.loc['G'][5],table_2.loc['G'][5],table_3.loc['G'][5],table_4.loc['G'][5],
           table_5.loc['G'][5],table_6.loc['G'][5],table_7.loc['G'][5],table_8.loc['G'][5],
           table_9.loc['G'][5],table_10.loc['G'][5]])


a43=np.mean([table_1.loc['H'].accuracy,table_2.loc['H'].accuracy,table_3.loc['H'].accuracy,table_4.loc['H'].accuracy,
...
a44=np.mean([table_1.loc['H'].f1_score,table_2.loc['H'].f1_score,table_3.loc['H'].f1_score,table_4.loc['H'].f1_score,
...
a45=np.mean([table_1.loc['H'][2],table_2.loc['H'][2],table_3.loc['H'][2],table_4.loc['H'][2],
           table_5.loc['H'][2],table_6.loc['H'][2],table_7.loc['H'][2],table_8.loc['H'][2],
           table_9.loc['H'][2],table_10.loc['H'][2]])


a46=np.mean([table_1.loc['H'][3],table_2.loc['H'][3],table_3.loc['H'][3],table_4.loc['H'][3],
           table_5.loc['H'][3],table_6.loc['H'][3],table_7.loc['H'][3],table_8.loc['H'][3],
           table_9.loc['H'][3],table_10.loc['H'][3]])

a47=np.mean([table_1.loc['H'][4],table_2.loc['H'][4],table_3.loc['H'][4],table_4.loc['H'][4],
           table_5.loc['H'][4],table_6.loc['H'][4],table_7.loc['H'][4],table_8.loc['H'][4],
           table_9.loc['H'][4],table_10.loc['H'][4]])

a48=np.mean([table_1.loc['H'][5],table_2.loc['H'][5],table_3.loc['H'][5],table_4.loc['H'][5],
           table_5.loc['H'][5],table_6.loc['H'][5],table_7.loc['H'][5],table_8.loc['H'][5],
           table_9.loc['H'][5],table_10.loc['H'][5]])


a49=np.mean([table_1.loc['I'].accuracy,table_2.loc['I'].accuracy,table_3.loc['I'].accuracy,table_4.loc['I'].accuracy,
...
a50=np.mean([table_1.loc['I'].f1_score,table_2.loc['I'].f1_score,table_3.loc['I'].f1_score,table_4.loc['I'].f1_score,
...
a51=np.mean([table_1.loc['I'][2],table_2.loc['I'][2],table_3.loc['I'][2],table_4.loc['I'][2],
           table_5.loc['I'][2],table_6.loc['I'][2],table_7.loc['I'][2],table_8.loc['I'][2],
           table_9.loc['I'][2],table_10.loc['I'][2]])


a52=np.mean([table_1.loc['I'][3],table_2.loc['I'][3],table_3.loc['I'][3],table_4.loc['I'][3],
           table_5.loc['I'][3],table_6.loc['I'][3],table_7.loc['I'][3],table_8.loc['I'][3],
           table_9.loc['I'][3],table_10.loc['I'][3]])

a53=np.mean([table_1.loc['I'][4],table_2.loc['I'][4],table_3.loc['I'][4],table_4.loc['I'][4],
           table_5.loc['I'][4],table_6.loc['I'][4],table_7.loc['I'][4],table_8.loc['I'][4],
           table_9.loc['I'][4],table_10.loc['I'][4]])

a54=np.mean([table_1.loc['I'][5],table_2.loc['I'][5],table_3.loc['I'][5],table_4.loc['I'][5],
           table_5.loc['I'][5],table_6.loc['I'][5],table_7.loc['I'][5],table_8.loc['I'][5],
           table_9.loc['I'][5],table_10.loc['I'][5]])


a55=np.mean([table_1.loc['J'].accuracy,table_2.loc['J'].accuracy,table_3.loc['J'].accuracy,table_4.loc['J'].accuracy,
...
a56=np.mean([table_1.loc['J'].f1_score,table_2.loc['J'].f1_score,table_3.loc['J'].f1_score,table_4.loc['J'].f1_score,
...
a57=np.mean([table_1.loc['J'][2],table_2.loc['J'][2],table_3.loc['J'][2],table_4.loc['J'][2],
           table_5.loc['J'][2],table_6.loc['J'][2],table_7.loc['J'][2],table_8.loc['J'][2],
           table_9.loc['J'][2],table_10.loc['J'][2]])


a58=np.mean([table_1.loc['J'][3],table_2.loc['J'][3],table_3.loc['J'][3],table_4.loc['J'][3],
           table_5.loc['J'][3],table_6.loc['J'][3],table_7.loc['J'][3],table_8.loc['J'][3],
           table_9.loc['J'][3],table_10.loc['J'][3]])

a59=np.mean([table_1.loc['J'][4],table_2.loc['J'][4],table_3.loc['J'][4],table_4.loc['J'][4],
           table_5.loc['J'][4],table_6.loc['J'][4],table_7.loc['J'][4],table_8.loc['J'][4],
           table_9.loc['J'][4],table_10.loc['J'][4]])

a60=np.mean([table_1.loc['J'][5],table_2.loc['J'][5],table_3.loc['J'][5],table_4.loc['J'][5],
           table_5.loc['J'][5],table_6.loc['J'][5],table_7.loc['J'][5],table_8.loc['J'][5],
           table_9.loc['J'][5],table_10.loc['J'][5]])

a61=np.mean([table_1.loc['K'].accuracy,table_2.loc['K'].accuracy,table_3.loc['K'].accuracy,table_4.loc['K'].accuracy,
...
a62=np.mean([table_1.loc['K'].f1_score,table_2.loc['K'].f1_score,table_3.loc['K'].f1_score,table_4.loc['K'].f1_score,
...
a63=np.mean([table_1.loc['K'][2],table_2.loc['K'][2],table_3.loc['K'][2],table_4.loc['K'][2],
           table_5.loc['K'][2],table_6.loc['K'][2],table_7.loc['K'][2],table_8.loc['K'][2],
           table_9.loc['K'][2],table_10.loc['K'][2]])


a64=np.mean([table_1.loc['K'][3],table_2.loc['K'][3],table_3.loc['K'][3],table_4.loc['K'][3],
           table_5.loc['K'][3],table_6.loc['K'][3],table_7.loc['K'][3],table_8.loc['K'][3],
           table_9.loc['K'][3],table_10.loc['K'][3]])

a65=np.mean([table_1.loc['K'][4],table_2.loc['K'][4],table_3.loc['K'][4],table_4.loc['K'][4],
           table_5.loc['K'][4],table_6.loc['K'][4],table_7.loc['K'][4],table_8.loc['K'][4],
           table_9.loc['K'][4],table_10.loc['K'][4]])

a66=np.mean([table_1.loc['K'][5],table_2.loc['K'][5],table_3.loc['K'][5],table_4.loc['K'][5],
           table_5.loc['K'][5],table_6.loc['K'][5],table_7.loc['K'][5],table_8.loc['K'][5],
           table_9.loc['K'][5],table_10.loc['K'][5]])

a67=np.mean([table_1.loc['L'].accuracy,table_2.loc['L'].accuracy,table_3.loc['L'].accuracy,table_4.loc['L'].accuracy,
...
a68=np.mean([table_1.loc['L'].f1_score,table_2.loc['L'].f1_score,table_3.loc['L'].f1_score,table_4.loc['L'].f1_score,
...
a69=np.mean([table_1.loc['L'][2],table_2.loc['L'][2],table_3.loc['L'][2],table_4.loc['L'][2],
           table_5.loc['L'][2],table_6.loc['L'][2],table_7.loc['L'][2],table_8.loc['L'][2],
           table_9.loc['L'][2],table_10.loc['L'][2]])


a70=np.mean([table_1.loc['L'][3],table_2.loc['L'][3],table_3.loc['L'][3],table_4.loc['L'][3],
           table_5.loc['L'][3],table_6.loc['L'][3],table_7.loc['L'][3],table_8.loc['L'][3],
           table_9.loc['L'][3],table_10.loc['L'][3]])

a71=np.mean([table_1.loc['L'][4],table_2.loc['L'][4],table_3.loc['L'][4],table_4.loc['L'][4],
           table_5.loc['L'][4],table_6.loc['L'][4],table_7.loc['L'][4],table_8.loc['L'][4],
           table_9.loc['L'][4],table_10.loc['L'][4]])

a72=np.mean([table_1.loc['L'][5],table_2.loc['L'][5],table_3.loc['L'][5],table_4.loc['L'][5],
           table_5.loc['L'][5],table_6.loc['L'][5],table_7.loc['L'][5],table_8.loc['L'][5],
           table_9.loc['L'][5],table_10.loc['L'][5]])


a73=np.mean([table_1.loc['M'].accuracy,table_2.loc['M'].accuracy,table_3.loc['M'].accuracy,table_4.loc['M'].accuracy,
...
a74=np.mean([table_1.loc['M'].f1_score,table_2.loc['M'].f1_score,table_3.loc['M'].f1_score,table_4.loc['M'].f1_score,
...
a75=np.mean([table_1.loc['M'][2],table_2.loc['M'][2],table_3.loc['M'][2],table_4.loc['M'][2],
           table_5.loc['M'][2],table_6.loc['M'][2],table_7.loc['M'][2],table_8.loc['M'][2],
           table_9.loc['M'][2],table_10.loc['M'][2]])


a76=np.mean([table_1.loc['M'][3],table_2.loc['M'][3],table_3.loc['M'][3],table_4.loc['M'][3],
           table_5.loc['M'][3],table_6.loc['M'][3],table_7.loc['M'][3],table_8.loc['M'][3],
           table_9.loc['M'][3],table_10.loc['M'][3]])

a77=np.mean([table_1.loc['M'][4],table_2.loc['M'][4],table_3.loc['M'][4],table_4.loc['M'][4],
           table_5.loc['M'][4],table_6.loc['M'][4],table_7.loc['M'][4],table_8.loc['M'][4],
           table_9.loc['M'][4],table_10.loc['M'][4]])

a78=np.mean([table_1.loc['M'][5],table_2.loc['M'][5],table_3.loc['M'][5],table_4.loc['M'][5],
           table_5.loc['M'][5],table_6.loc['M'][5],table_7.loc['M'][5],table_8.loc['M'][5],
           table_9.loc['M'][5],table_10.loc['M'][5]])


a79=np.mean([table_1.loc['.'].accuracy,table_2.loc['.'].accuracy,table_3.loc['.'].accuracy,table_4.loc['.'].accuracy,
...
a80=np.mean([table_1.loc['.'].f1_score,table_2.loc['.'].f1_score,table_3.loc['.'].f1_score,table_4.loc['.'].f1_score,
...
a81=np.mean([table_1.loc['.'][2],table_2.loc['.'][2],table_3.loc['.'][2],table_4.loc['.'][2],
           table_5.loc['.'][2],table_6.loc['.'][2],table_7.loc['.'][2],table_8.loc['.'][2],
           table_9.loc['.'][2],table_10.loc['.'][2]])


a82=np.mean([table_1.loc['.'][3],table_2.loc['.'][3],table_3.loc['.'][3],table_4.loc['.'][3],
           table_5.loc['.'][3],table_6.loc['.'][3],table_7.loc['.'][3],table_8.loc['.'][3],
           table_9.loc['.'][3],table_10.loc['.'][3]])

a83=np.mean([table_1.loc['.'][4],table_2.loc['.'][4],table_3.loc['.'][4],table_4.loc['.'][4],
           table_5.loc['.'][4],table_6.loc['.'][4],table_7.loc['.'][4],table_8.loc['.'][4],
           table_9.loc['.'][4],table_10.loc['.'][4]])

a84=np.mean([table_1.loc['.'][5],table_2.loc['.'][5],table_3.loc['.'][5],table_4.loc['.'][5],
