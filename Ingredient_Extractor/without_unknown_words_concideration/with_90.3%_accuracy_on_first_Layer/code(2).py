    ...
    def get_state_sequence(self, x,y):
        ...
        for i in range(self.M1):
                for j in range(self.M):
                    delta1[0,i,j]=np.log(self.pi[j])+np.log(self.C[i,j,x[1]])
        for t in range(1, T-1):
            for j in range(self.M):
                for i in range(self.M1):
                    delta1[t,i,j]=np.max(delta1[t-1,i,:]+np.log(self.D[i,:,j]))+np.multiply(4,np.log(self.C[i,j,x[t+1]]))
                    #delta1[t,i,j]=np.max(delta1[t-1,i,:]+np.log(self.D[i,:,j]))+np.log(self.C[i,j,x[t+1]])
...
P1train = []
for x,y in zip(Xtrain,Y11train):
...
accuracy=accuracy(Ptrain, P1train)
print("test f1:", total_f1_score(Ptrain, P1train))
f1=total_f1_score(Ptrain, P1train)
print("test accuracy for unknown words:",accuracy_unknown(Ptrain, P1train,Xtrain))
unknown_ac=accuracy_unknown(Ptrain, P1train,Xtrain)
print("test accuracy for known words:",accuracy_known(Ptrain, P1train,Xtrain))
known_ac=accuracy_known(Ptrain, P1train,Xtrain)


Y=np.concatenate(Ytrain)
P=np.concatenate(Ptrain)
Z=np.concatenate(P1train)
...
str_pythontex=[float("{0:.2f}".format(list(table_21.loc["A"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["A"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["A"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["A"])[4]*100)),
round(list(table_21.loc["A"])[3]),round(list(table_21.loc["A"])[5]),
float("{0:.2f}".format(list(table_21.loc["B"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["B"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["B"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["B"])[4]*100)),
round(list(table_21.loc["B"])[3]),round(list(table_21.loc["B"])[5]),
float("{0:.2f}".format(list(table_21.loc["C"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["C"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["C"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["C"])[4]*100)),
round(list(table_21.loc["C"])[3]),round(list(table_21.loc["C"])[5]),
float("{0:.2f}".format(list(table_21.loc["D"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["D"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["D"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["D"])[4]*100)),
round(list(table_21.loc["D"])[3]),round(list(table_21.loc["D"])[5]),
float("{0:.2f}".format(list(table_21.loc["E"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["E"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["E"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["E"])[4]*100)),
round(list(table_21.loc["E"])[3]),round(list(table_21.loc["E"])[5]),
float("{0:.2f}".format(list(table_21.loc["F"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["F"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["F"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["F"])[4]*100)),
round(list(table_21.loc["F"])[3]),round(list(table_21.loc["F"])[5]),
float("{0:.2f}".format(list(table_21.loc["G"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["G"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["G"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["G"])[4]*100)),
round(list(table_21.loc["G"])[3]),round(list(table_21.loc["G"])[5]),
float("{0:.2f}".format(list(table_21.loc["H"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["H"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["H"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["H"])[4]*100)),
round(list(table_21.loc["H"])[3]),round(list(table_21.loc["H"])[5]),
float("{0:.2f}".format(list(table_21.loc["I"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["I"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["I"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["I"])[4]*100)),
round(list(table_21.loc["I"])[3]),round(list(table_21.loc["I"])[5]),
float("{0:.2f}".format(list(table_21.loc["J"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["J"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["J"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["J"])[4]*100)),
round(list(table_21.loc["J"])[3]),round(list(table_21.loc["J"])[5]),
float("{0:.2f}".format(list(table_21.loc["K"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["K"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["K"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["K"])[4]*100)),
round(list(table_21.loc["K"])[3]),round(list(table_21.loc["K"])[5]),
float("{0:.2f}".format(list(table_21.loc["L"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["L"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["L"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["L"])[4]*100)),
round(list(table_21.loc["L"])[3]),round(list(table_21.loc["L"])[5]),
float("{0:.2f}".format(list(table_21.loc["M"])[0]*100)),float("{0:.2f}".format(list(table_21.loc["M"])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["M"])[2]*100)),float("{0:.2f}".format(list(table_21.loc["M"])[4]*100)),
round(list(table_21.loc["M"])[3]),round(list(table_21.loc["M"])[5]),
float("{0:.2f}".format(list(table_21.loc["."])[0]*100)),float("{0:.2f}".format(list(table_21.loc["."])[1]*100)),
float("{0:.2f}".format(list(table_21.loc["."])[2]*100)),float("{0:.2f}".format(list(table_21.loc["."])[4]*100)),
round(list(table_21.loc["."])[3]),round(list(table_21.loc["."])[5]),
...
v21=[float("{0:.2f}".format(float(accuracy)*100)),float("{0:.2f}".format(float(f1)*100)),
float("{0:.2f}".format(float(unknown_ac)*100)),float("{0:.2f}".format(float(known_ac)*100)),
len(word2idx)-w_known,float("{0:.2f}".format(float((len(word2idx)-w_known)/len(word2idx))*100))]
...
#    Y=[]
#    for x1 in x[1:]:
#        Y.append([*word2idx][x1])
#    words_sequences.append(Y)
#    
#compare = lambda x, y: collections.Counter(x) == collections.Counter(y)
#i=0
#notSimilar=[]
#for x,y in zip(Ptrain,P1train):
#    if not(compare(x,y)):
#        notSimilar.append(i)
#    i=i+1
