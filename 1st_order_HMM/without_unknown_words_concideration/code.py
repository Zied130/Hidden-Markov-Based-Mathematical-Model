...
accuracy=accuracy(Ytrain, Ptrain)
print("test f1:", total_f1_score(Ytrain, Ptrain))
f1=total_f1_score(Ytrain, Ptrain)
print("test accuracy for unknown words:",accuracy_unknown(Ytrain, Ptrain,Xtrain))
unknown_ac=accuracy_unknown(Ytrain, Ptrain,Xtrain)
print("test accuracy for known words:",accuracy_known(Ytrain, Ptrain,Xtrain))
known_ac=accuracy_known(Ytrain, Ptrain,Xtrain)


Y = np.concatenate(tag)
P = np.concatenate(Ptrain)
Z = np.concatenate(Ytrain)   
